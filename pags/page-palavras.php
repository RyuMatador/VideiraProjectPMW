...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU"
        crossorigin="anonymous">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri()?>/styles/style-palavras.css">
</head>
    ...
    <nav class="py-2 m-0" style="background-image: url(<?php echo get_stylesheet_directory_uri()?>/imgs/blurred-background.jpg);background-repeat: no-repeat; background-size: cover; z-index: 2;" >
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-5 text-left pt-md-4">Palavra da célula</h1>
                    <p class="font-weight-light font-italic pt-2 palavra-titulo"> <?php the_title(); date_add?></p>
            </div>
        </div>
    </nav>
    ...
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <article class="container">
            <section class="row">
                <div class="col-lg-10 py-3 py-md-4">
                    <?php the_content();?>
                </div>
            </section>
        </article>
    ...
    <?php endwhile; else: ?>
        ...
        viewBox="0 0 512.003 512.003" style="width:10em;enable-background:new 0 0 512.003 512.003;" xml:space="preserve">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-6 col-sm-12 text-center text-lg-left pb-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="pags/redes.html">Redes</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 d-flex justify-content-center justify-content-lg-start">
                    <ul class="list-unstyled d-flex m-0">
                        <li><a class="btn btn-outline-secondary mx-1 my-1 facebook-style" href="https://pt-br.facebook.com/videirapalmas/">Facebook</a></li>
                        <li><a class="btn btn-outline-secondary mx-1 my-1 twitter-style" href="https://twitter.com/videirapalmas">Twitter</a></li>
                        <li><a class="btn btn-outline-secondary mx-1 my-1 instagram-style" href="https://www.instagram.com/videirapalmas/">Instagram</a></li>
                    </ul>
                </div>
